...
public class DepthFirstSearch extends SearchAlgorithm {
	...
	//The open or frontier hexagons, depth first is identical to breadth-first, but using a stack, instead of a queue
	Stack<Hexagon<HexData>> openList;
	...
	public int step(){
		...
		Hexagon<HexData> current = openList.pop();
